...
- [x] **2. Asymmetric MAX_LEN (LLM stream at 1024)**  
...
- [x] **3. LLM confidence scores as scalar features**  
...
- [x] **4. Mean pooling instead of CLS-only**  
...
- [x] **6. LLM answer correctness as a binary feature**  
